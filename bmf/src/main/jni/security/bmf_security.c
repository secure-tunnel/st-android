...
jbyteArray Java_com_bankcomm_bmf_security_SM3_hash(JNIEnv *env, jclass cls, jbyteArray data, jint datalen) {
...
jbyteArray Java_com_bankcomm_bmf_security_SM4_encrypt(JNIEnv *env, jclass cls, jbyteArray data, jint datalen, jbyteArray key, jint keylen, jbyteArray iv, jint ivlen) {
    /* 预处理参数类型 */
...
jbyteArray Java_com_bankcomm_bmf_security_SM4_decrypt(JNIEnv *env, jclass cls, jbyteArray data, jint datalen, jbyteArray key, jint keylen, jbyteArray iv, jint ivlen) {
    /* 预处理参数类型 */
    unsigned char * keyChars = (unsigned char *) (*env)->GetByteArrayElements(env, key, 0);
    unsigned char * ivChars = (unsigned char *) (*env)->GetByteArrayElements(env, iv, 0);
    unsigned char * dataChars = (unsigned char *) (*env)->GetByteArrayElements(env, data, 0);
...
jbyteArray Java_com_bankcomm_bmf_security_SM2_encrypt(JNIEnv *env, jclass cls, jbyteArray data, jint datalen, jbyteArray publickey, jint publickeylen) {
...
jbyteArray Java_com_bankcomm_bmf_security_SM2_decrypt(JNIEnv *env, jclass cls, jbyteArray data, jint datalen, jbyteArray privatekey, jint privatekeylen) {
    EVP_PKEY_CTX *ectx = NULL;
    EVP_PKEY *pkey = EVP_PKEY_new();
...
jbyteArray Java_com_bankcomm_bmf_security_SM2_sign(JNIEnv *env, jclass cls, jbyteArray data, jint datalen, jbyteArray privatekey, jint privatekeylen) {
...
jint Java_com_bankcomm_bmf_security_SM2_verify(JNIEnv *env, jclass cls, jbyteArray data, jint datalen, jbyteArray signdata, jint signdatalen, jbyteArray publickey, jint publickeylen) {
    int ret_val = 0;
    EVP_PKEY *evpPkey = EVP_PKEY_new();
    EVP_MD_CTX *evpMdCtx = NULL;
